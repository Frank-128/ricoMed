...
function Dashboard() {
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="basis-1/5 flex md:justify-around overflow-x-scroll gap-x-3 my-1">
        <div className=" flex-shrink-0 md:w-1/4 w-1/2">
          <span>Doctors</span>
        ...
        <div className="flex-shrink-0  md:w-1/4 w-1/2 ">
          ...
          <div className="flex flex-col  gap-3 bg-slate-200 shadow-md   p-3 justify-between h-4/5 ">
            <div className="flex flex-col ">
              <span>
                <ArrowUpward color="success" /> Income
              </span>
              <span className="font-bold text-green-600">4500000</span>
            </div>
            <div className="flex flex-col ">
              <span>
                <ArrowDownward color="warning" /> Expenses
              </span>
      ...
      <div className="basis-1/5 ">
        ...
        <div className="flex gap-3 bg-slate-200 md: overflow-x-scroll justify-evenly rounded shadow-sm">
